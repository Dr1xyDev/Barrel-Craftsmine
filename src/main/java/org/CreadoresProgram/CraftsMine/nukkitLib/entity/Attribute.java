package org.CreadoresProgram.CraftsMine.nukkitLib.entity;
/**
 * Attribute
 *
...
public class Attribute implements Cloneable {
    ...
    public Attribute(int id, String name, float minValue, float maxValue, float defaultValue, boolean shouldSend) {
        this.id = id;
        this.name = name;
    ...
    public static Attribute getAttribute(int id) {
        ...
        throw new RuntimeException("Attribute id: " + id + " not found");
    }
